...
export const BasicFeeAllowance = {
  encode(message: BasicFeeAllowance, writer: Writer = Writer.create()): Writer {
    for (const v of message.spendLimit) {
      Coin.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    if (message.expiration !== undefined) {
      ExpiresAt.encode(message.expiration, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.expiration = ExpiresAt.decode(reader, reader.uint32());
          break;
        default:
...
export const PeriodicFeeAllowance = {
  encode(
    ...
    if (message.periodReset !== undefined) {
      ExpiresAt.encode(message.periodReset, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): PeriodicFeeAllowance {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.basic = BasicFeeAllowance.decode(reader, reader.uint32());
          break;
        case 2:
        ...
        case 4:
          ...
          break;
        case 5:
          message.periodReset = ExpiresAt.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
...
export const AllowedMsgFeeAllowance = {
  ...
  decode(input: Reader | Uint8Array, length?: number): AllowedMsgFeeAllowance {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
  ...
  fromPartial(
    ...
    const message = { ...baseAllowedMsgFeeAllowance } as AllowedMsgFeeAllowance;
    message.allowedMessages = [];
    if (object.allowance !== undefined && object.allowance !== null) {
...
export const FeeAllowanceGrant = {
  encode(message: FeeAllowanceGrant, writer: Writer = Writer.create()): Writer {
    if (message.granter !== "") {
