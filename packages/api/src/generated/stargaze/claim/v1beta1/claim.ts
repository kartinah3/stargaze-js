...
export function actionFromJSON(object: any): Action {
	switch (object) {
		case 0:
		case 'ActionMintSocialToken':
			return Action.ActionMintSocialToken;
		case 1:
...
export function actionToJSON(object: Action): string {
	switch (object) {
		case Action.ActionMintSocialToken:
...
export const ClaimRecord = {
	...
	toJSON(message: ClaimRecord): unknown {
		...
		if (message.initialClaimableAmount) {
			obj.initialClaimableAmount = message.initialClaimableAmount.map(
