...
export const Tx = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Tx {
    ...
    const message = globalThis.Object.create(baseTx) as Tx;
    message.signatures = [];
...
export const TxRaw = {
  ...
  decode(input: Reader | Uint8Array, length?: number): TxRaw {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseTxRaw) as TxRaw;
    message.signatures = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const SignDoc = {
  ...
  decode(input: Reader | Uint8Array, length?: number): SignDoc {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseSignDoc) as SignDoc;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const TxBody = {
  ...
  decode(input: Reader | Uint8Array, length?: number): TxBody {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseTxBody) as TxBody;
    message.messages = [];
...
export const AuthInfo = {
  ...
  decode(input: Reader | Uint8Array, length?: number): AuthInfo {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseAuthInfo) as AuthInfo;
    message.signerInfos = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const SignerInfo = {
  ...
  decode(input: Reader | Uint8Array, length?: number): SignerInfo {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseSignerInfo) as SignerInfo;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ModeInfo = {
  ...
  decode(input: Reader | Uint8Array, length?: number): ModeInfo {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseModeInfo) as ModeInfo;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
