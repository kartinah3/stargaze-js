...
export const MsgStoreCode = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgStoreCode {
    ...
    const message = globalThis.Object.create(baseMsgStoreCode) as MsgStoreCode;
