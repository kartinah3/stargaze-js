...
export interface MsgDescriptor {
  ...
  serviceMsg?: ServiceMsgDescriptor | undefined;
}

/** ServiceMsgDescriptor describes an sdk.ServiceMsg type */
export interface ServiceMsgDescriptor {
  /**
...
export const TxDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): TxDescriptor {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseTxDescriptor) as TxDescriptor;
    message.msgs = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const MsgDescriptor = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDescriptor {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.serviceMsg = ServiceMsgDescriptor.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): MsgDescriptor {
    ...
    if (object.serviceMsg !== undefined && object.serviceMsg !== null) {
      message.serviceMsg = ServiceMsgDescriptor.fromJSON(object.serviceMsg);
    } else {
  ...
  fromPartial(object: DeepPartial<MsgDescriptor>): MsgDescriptor {
    ...
    if (object.serviceMsg !== undefined && object.serviceMsg !== null) {
      message.serviceMsg = ServiceMsgDescriptor.fromPartial(object.serviceMsg);
    } else {
      message.serviceMsg = undefined;
    }
    return message;
  ...
  toJSON(message: MsgDescriptor): unknown {
    ...
    message.serviceMsg !== undefined &&
      (obj.serviceMsg = message.serviceMsg
        ? ServiceMsgDescriptor.toJSON(message.serviceMsg)
        : undefined);
    return obj;
  },
};

const baseServiceMsgDescriptor: object = {
  requestFullname: "",
  requestRoute: "",
  requestTypeUrl: "",
  responseFullname: "",
...
export const ServiceMsgDescriptor = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): ServiceMsgDescriptor {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
      baseServiceMsgDescriptor
    ) as ServiceMsgDescriptor;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ServiceMsgDescriptor {
    const message = globalThis.Object.create(
      baseServiceMsgDescriptor
    ) as ServiceMsgDescriptor;
    if (
      object.requestFullname !== undefined &&
    ...
    if (
      object.responseFullname !== undefined &&
  ...
  fromPartial(object: DeepPartial<ServiceMsgDescriptor>): ServiceMsgDescriptor {
    const message = { ...baseServiceMsgDescriptor } as ServiceMsgDescriptor;
    if (
      object.requestFullname !== undefined &&
      object.requestFullname !== null
    ) {
  ...
  toJSON(message: ServiceMsgDescriptor): unknown {
    const obj: any = {};
