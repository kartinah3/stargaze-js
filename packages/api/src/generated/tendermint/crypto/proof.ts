...
export const Proof = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Proof {
    ...
    const message = globalThis.Object.create(baseProof) as Proof;
    message.aunts = [];
...
export const ValueOp = {
  ...
  decode(input: Reader | Uint8Array, length?: number): ValueOp {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseValueOp) as ValueOp;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const DominoOp = {
  ...
  decode(input: Reader | Uint8Array, length?: number): DominoOp {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseDominoOp) as DominoOp;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ProofOp = {
  ...
  decode(input: Reader | Uint8Array, length?: number): ProofOp {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseProofOp) as ProofOp;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ProofOps = {
  ...
  decode(input: Reader | Uint8Array, length?: number): ProofOps {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseProofOps) as ProofOps;
    message.ops = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
