...
export const Swagger = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Swagger {
    ...
    const message = globalThis.Object.create(baseSwagger) as Swagger;
    message.schemes = [];
    message.consumes = [];
    message.produces = [];
    message.responses = {};
...
export const Header = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Header {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseHeader) as Header;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const Response_HeadersEntry = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Response_HeadersEntry {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
      baseResponse_HeadersEntry
    ) as Response_HeadersEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const Response_ExamplesEntry = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Response_ExamplesEntry {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
      baseResponse_ExamplesEntry
    ) as Response_ExamplesEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const Info = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Info {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseInfo) as Info;
    message.extensions = {};
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const Info_ExtensionsEntry = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Info_ExtensionsEntry {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
      baseInfo_ExtensionsEntry
    ) as Info_ExtensionsEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const License = {
  ...
  decode(input: Reader | Uint8Array, length?: number): License {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseLicense) as License;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const Schema = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Schema {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseSchema) as Schema;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const JSONSchema = {
  ...
  decode(input: Reader | Uint8Array, length?: number): JSONSchema {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseJSONSchema) as JSONSchema;
    message.required = [];
    message.array = [];
    message.type = [];
    message.enum = [];
  ...
  fromJSON(object: any): JSONSchema {
    ...
    if (object.maxLength !== undefined && object.maxLength !== null) {
      message.maxLength = Long.fromString(object.maxLength);
    } else {
      message.maxLength = Long.UZERO;
    }
    if (object.minLength !== undefined && object.minLength !== null) {
      message.minLength = Long.fromString(object.minLength);
    } else {
      message.minLength = Long.UZERO;
    }
    if (object.pattern !== undefined && object.pattern !== null) {
      message.pattern = String(object.pattern);
    } else {
    ...
    if (object.maxItems !== undefined && object.maxItems !== null) {
      message.maxItems = Long.fromString(object.maxItems);
    } else {
      message.maxItems = Long.UZERO;
    }
    if (object.minItems !== undefined && object.minItems !== null) {
      message.minItems = Long.fromString(object.minItems);
    } else {
      message.minItems = Long.UZERO;
    }
    ...
    if (object.maxProperties !== undefined && object.maxProperties !== null) {
      message.maxProperties = Long.fromString(object.maxProperties);
    } else {
      message.maxProperties = Long.UZERO;
    }
    if (object.minProperties !== undefined && object.minProperties !== null) {
      message.minProperties = Long.fromString(object.minProperties);
    } else {
      message.minProperties = Long.UZERO;
    }
  ...
  fromPartial(object: DeepPartial<JSONSchema>): JSONSchema {
    ...
    if (object.maxLength !== undefined && object.maxLength !== null) {
      message.maxLength = object.maxLength as Long;
    } else {
      message.maxLength = Long.UZERO;
    }
    if (object.minLength !== undefined && object.minLength !== null) {
      message.minLength = object.minLength as Long;
    } else {
      message.minLength = Long.UZERO;
    }
    if (object.pattern !== undefined && object.pattern !== null) {
    ...
    if (object.maxItems !== undefined && object.maxItems !== null) {
      message.maxItems = object.maxItems as Long;
    } else {
      message.maxItems = Long.UZERO;
    }
    if (object.minItems !== undefined && object.minItems !== null) {
      message.minItems = object.minItems as Long;
    } else {
      message.minItems = Long.UZERO;
    }
    if (object.uniqueItems !== undefined && object.uniqueItems !== null) {
    ...
    if (object.maxProperties !== undefined && object.maxProperties !== null) {
      message.maxProperties = object.maxProperties as Long;
    } else {
      message.maxProperties = Long.UZERO;
    }
    if (object.minProperties !== undefined && object.minProperties !== null) {
      message.minProperties = object.minProperties as Long;
    } else {
      message.minProperties = Long.UZERO;
    }
    if (object.required !== undefined && object.required !== null) {
...
export const Tag = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Tag {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseTag) as Tag;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
...
export const Scopes = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Scopes {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseScopes) as Scopes;
    message.scope = {};
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const Scopes_ScopeEntry = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Scopes_ScopeEntry {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(
      baseScopes_ScopeEntry
    ) as Scopes_ScopeEntry;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
