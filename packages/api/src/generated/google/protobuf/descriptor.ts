...
export const FileOptions = {
  ...
  decode(input: Reader | Uint8Array, length?: number): FileOptions {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseFileOptions) as FileOptions;
    message.uninterpretedOption = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const FieldOptions = {
  ...
  decode(input: Reader | Uint8Array, length?: number): FieldOptions {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseFieldOptions) as FieldOptions;
    message.uninterpretedOption = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const OneofOptions = {
  ...
  decode(input: Reader | Uint8Array, length?: number): OneofOptions {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseOneofOptions) as OneofOptions;
    message.uninterpretedOption = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
export const EnumOptions = {
  ...
  decode(input: Reader | Uint8Array, length?: number): EnumOptions {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = globalThis.Object.create(baseEnumOptions) as EnumOptions;
    message.uninterpretedOption = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
